  ...
  try {
    ...
    if (event.httpMethod === 'POST' && action === 'research') {
      ...
      const prompt = isPoi
        ...
        : `Research this gap in our Saint Vincent and the Grenadines knowledge base: "${query_text}". Use web search across multiple independent sources. Return ONLY a JSON object, no other text, shaped exactly like: {"category": "geography|history|government|culture|economy|practical|music|motorsports|vincy_mas", "title": "...", "summary": "3-5 sentences, original synthesis in your own words, not copied text", "source_url": "..."}.`;
